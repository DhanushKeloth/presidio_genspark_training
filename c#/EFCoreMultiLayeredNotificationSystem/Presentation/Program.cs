        ...
        while (running)
        {
            ...
            switch (input)
            {
                case "1":
                    ...
                    Console.WriteLine($"User added successfully with name: {newUser.Name}");
                    idCounter++;
                    break;
...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        var userrepo = new UserRepository<int, User>(new NotificationDbContext());
        var notificationrepo = new NotificationRepository<string, Notification>(new NotificationDbContext());
